...
## page was copied from WilyWerewolf/ReleaseNotes
...
These release notes for '''Ubuntu 16.04.7 LTS''' (Xenial Xerus) provide an overview of the release and document the known issues with Ubuntu 16.04 LTS and its flavours.  For details of the changes applied since 16.04, please see the [[XenialXerus/ReleaseNotes/ChangeSummary/16.04.7|16.04.7 change summary]].  The release notes for [[XenialXerus/ReleaseNotes/16.04|16.04]], [[XenialXerus/ReleaseNotes/16.04.1|16.04.1]], [[XenialXerus/ReleaseNotes/16.04.2|16.04.2]], [[XenialXerus/ReleaseNotes/16.04.3|16.04.3]], [[XenialXerus/ReleaseNotes/16.04.4|16.04.4]], [[XenialXerus/ReleaseNotes/16.04.5|16.04.5]] and [[XenialXerus/ReleaseNotes/16.04.6|16.04.6]] are available as well.

Please refer to Change Summary notes for [[XenialXerus/ReleaseNotes/ChangeSummary/16.04.7|16.04.7]] if interested in the latest 16.04.7 release.
...
You can download images from:  http://releases.ubuntu.com/xenial/

## - these no longer point valid - commented out 
##http://releases.ubuntu.com/16.04.4/ (Ubuntu Desktop and Server) <<BR>>
##http://cdimage.ubuntu.com/ubuntu/releases/16.04.4/release/ (Less Popular Ubuntu Images) <<BR>>
##http://cdimage.ubuntu.com/netboot/16.04.4/ (Ubuntu Netboot) <<BR>>
##http://cdimage.ubuntu.com/ubuntu-base/releases/16.04.4/release/ (Ubuntu Base) <<BR>>
##http://cdimage.ubuntu.com/kubuntu/releases/16.04.4/release/ (Kubuntu) <<BR>>
##http://cdimage.ubuntu.com/lubuntu/releases/16.04.4/release/ (Lubuntu) <<BR>>
##http://cdimage.ubuntu.com/ubuntustudio/releases/16.04.4/release/ (Ubuntu Studio) <<BR>>
##http://cdimage.ubuntu.com/ubuntu-gnome/releases/16.04.4/release/ (Ubuntu GNOME) <<BR>>
##http://cdimage.ubuntu.com/ubuntukylin/releases/16.04.4/release/ (Ubuntu Kylin) <<BR>>
##http://cdimage.ubuntu.com/ubuntu-mate/releases/16.04.4/release/ (Ubuntu MATE) <<BR>>
##http://cdimage.ubuntu.com/xubuntu/releases/16.04.4/release/ (Xubuntu) <<BR>>
##http://cdimage.ubuntu.com/mythbuntu/releases/16.04.4/release/ (Mythbuntu) <<BR>>
...
Learn more about LXD here: http://www.ubuntu.com/cloud/lxd/ <<BR>>
...
Password behavior when the MySQL root password is empty has changed. Packaging now enables socket authentication when the MySQL root password is empty. This means that a non-root user can't log in as the MySQL root user with an empty password. For details, see the [[https://salsa.debian.org/mariadb-team/mysql/blob/1025a9fa9c6c112913c59138db49dbc94891d20f/debian/NEWS|NEWS]] file.
...
Running PCI pass-through with Ubuntu 16.04 kernel 4.4 and stock QEMU packages will lead to DI issues as soon as I/O starts on the pass-through adapter [[https://bugs.launchpad.net/ubuntu/+source/qemu/+bug/1801674|bug]]. In such a case an update to a QEMU packages with DDW support is required.
...
CPU hotplug on ppc64el was not yet supported with the QEMU and Libvirt versions available in Ubuntu 16.04. If required please consider upgrading to [[https://wiki.ubuntu.com/BionicBeaver/ReleaseNotes|18.04 (Bionic)]].
