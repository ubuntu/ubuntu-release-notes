...
<!-- SOURCE: https://wiki.ubuntu.com/NattyNarwhal/ReleaseNotes -->

(ubuntu-11-04-release-notes)=
# Ubuntu 11.04 release notes
...
[new scrollbar](https://launchpad.net/ayatana-scrollbar) which takes less
screen space.


(11-04-updated-applications)=
#### Updated Applications

Ubuntu 11.04 comes with the latest Firefox 4.0 as the standard web browser.

LibreOffice 3.3.2 has replaced OpenOffice.org in 11.04 as the default office
suite.
...
(11-04-improved-underlying-infrastructure)=
...
X.org 1.10.1 and Mesa 7.10.2 are the new versions included with 11.04.  The X server includes a prototype of the multitouch input extension (XInput 2.1). The Qt toolkit also includes pre-release support for multitouch.
...
(11-04-new-headless-images)=
#### _New_ Headless Images
...
[help.ubuntu.com/community/NattyUpgrades](https://help.ubuntu.com/community/NattyUpgrades)


(11-04-from-other-ubuntu-releases)=
...
[help.ubuntu.com/community/MaverickUpgrades](https://help.ubuntu.com/community/MaverickUpgrades)
...
(11-04-trackpads-touchscreens-mice-and-keyboards)=
...
you can participate at:  [www.ubuntu.com/community/participate](http://www.ubuntu.com/community/participate) .
...
found at: [help.ubuntu.com/community/ReportingBugs](https://help.ubuntu.com/community/ReportingBugs) .
