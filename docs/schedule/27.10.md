...
| 15 | August 05 |  |
| 16 | August 12 |  |
| 17 | August 19 | [Feature Freeze](https://wiki.ubuntu.com/FeatureFreeze), Debian Import Freeze |
| 18 | August 26 | Ubuntu Testing Week (optional) |
| **September 2027** |  |  |
| 19 | September 02 |  |
| 20 | September 09 | [User Interface Freeze](https://wiki.ubuntu.com/UserInterfaceFreeze) |
| 21 | September 16 | [Documentation String Freeze](https://wiki.ubuntu.com/DocumentationStringFreeze), [Kernel Feature Freeze](https://wiki.ubuntu.com/KernelFeatureFreeze) |
| 22 | September 20 (Monday) | [Beta Freeze](https://wiki.ubuntu.com/BetaFreeze), [Hardware Enablement Freeze](https://wiki.ubuntu.com/HardwareEnablementFreeze) |
| ⠀ | September 23 | Beta (mandatory) |
| 23 | September 30 | [Kernel Freeze](https://wiki.ubuntu.com/KernelFreeze), [Non Language Pack Translation Deadline](https://wiki.ubuntu.com/NonLanguagePackTranslationDeadline) |
| **October 2027** |  |  |
| 24 | October 07 | [Final Freeze](https://wiki.ubuntu.com/FinalFreeze), [Release Candidate](https://wiki.ubuntu.com/ReleaseCandidate), [Language Pack Translation Deadline](https://wiki.ubuntu.com/LanguagePackTranslationDeadline) |
| 25 | October 14 | [Final Release](https://wiki.ubuntu.com/FinalRelease) |
